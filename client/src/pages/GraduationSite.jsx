...
import { GraduationCap, Calendar, MapPin, Clock, Camera, Users, Loader, AlertCircle } from 'lucide-react'
import { API_URL } from '../config'

const GraduationSite = () => {
  ...
  useEffect(() => {
    const fetchTenant = async () => {
      try {
        ...
        if (!tenantSlug) {
          setError('Mezuniyet sitesi bulunamadı.')
          setLoading(false)
          return
        }
        ...
        setError(error.response?.data?.error || 'Mezuniyet sitesi yüklenirken bir hata oluştu.')
        setLoading(false)
      }
    }
  ...
  // Countdown timer
  useEffect(() => {
    if (!tenant?.graduationDate) return

    const updateCountdown = () => {
      const graduationDate = new Date(tenant.graduationDate)
      const now = new Date()
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Mezuniyet sitesi yükleniyor...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center">
          ...
          <a href="https://www.davet.digital" className="inline-block px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full font-semibold hover:shadow-lg transition-all">
            Ana Sayfaya Dön
          </a>
        </div>
      </div>
  ...
  const graduationDate = new Date(tenant.graduationDate)
  const formattedDate = graduationDate.toLocaleDateString('tr-TR', {
    day: 'numeric',
    month: 'long',
    year: 'numeric'
  })
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white py-32">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <div className="flex justify-center mb-8">
            <GraduationCap className="w-20 h-20 animate-pulse" />
          </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-script text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-12">
            Mezuniyete Kalan Süre
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-6 text-center text-white shadow-xl">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-center text-white shadow-xl animate-pulse">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-600">Mezuniyet mekanımız</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-2">{tenant.graduateName}</p>
          <p className="text-gray-400 text-sm">
            Bu mezuniyet sitesi <a href="https://www.davet.digital" className="text-blue-400 hover:text-blue-300">Davet Digital</a> ile oluşturulmuştur
          </p>
        </div>
      </div>
    </div>
