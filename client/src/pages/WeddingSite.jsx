...
const WeddingSite = () => {
  ...
  useEffect(() => {
    const fetchTenant = async () => {
      try {
        ...
        if (!tenantSlug) {
          setError('Düğün sitesi bulunamadı.')
          setLoading(false)
          return
        }
        ...
        setError(error.response?.data?.error || 'Düğün sitesi yüklenirken bir hata oluştu.')
        setLoading(false)
      }
    }
  ...
  // Countdown timer
  useEffect(() => {
    if (!tenant?.weddingDate) return

    const updateCountdown = () => {
      const weddingDate = new Date(tenant.weddingDate)
      const now = new Date()
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Düğün sitesi yükleniyor...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center">
          ...
          <a href="https://www.davet.digital" className="inline-block px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:shadow-lg transition-all">
            Ana Sayfaya Dön
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white py-32">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-script text-center text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600 mb-12">
            Büyük Güne Kalan Süre
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-6 text-center text-white shadow-xl">
              <p className="text-5xl font-bold mb-2">{countdown.days}</p>
              <p className="text-lg font-medium">Gün</p>
            </div>
            <div className="bg-gradient-to-br from-purple-500 to-fuchsia-600 rounded-2xl p-6 text-center text-white shadow-xl">
              <p className="text-5xl font-bold mb-2">{countdown.hours}</p>
              <p className="text-lg font-medium">Saat</p>
            </div>
            <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-6 text-center text-white shadow-xl">
              <p className="text-5xl font-bold mb-2">{countdown.minutes}</p>
              <p className="text-lg font-medium">Dakika</p>
            </div>
            <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-center text-white shadow-xl animate-pulse">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-600">Düğün mekanımız</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-2">{tenant.coupleNames}</p>
          <p className="text-gray-400 text-sm">
            Bu düğün sitesi <a href="https://www.davet.digital" className="text-pink-400 hover:text-pink-300">Davet Digital</a> ile oluşturulmuştur
          </p>
        </div>
      </div>
    </div>
